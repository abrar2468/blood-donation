                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        ...
                        <div class=" vbh">
                            ...
                            <div class="btn btn-success  bounceInUp"><a href="login.php" class="nav-link">Login</a></div>
                            <div class="btn btn-success  bounceInUp"> <a href="register.php" class="nav-link">SignUp</a></div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row content-ro">
                <div class="col-lg-4 col-md-12 footer-contact">
                    ...
                    <div class="address-row">
                        ...
                        <div class="detail">
                            <p> <br> MISTBlooddonate@gmail.com</p>
                        </div>
                    </div>
                    <div class="address-row">
                        <div class="icon">
                        ...
                        <div class="detail">
                            <p>01590063279 <br> 01623329513</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="footer-copy">
                <div class="row">
                    <div class="col-lg-8 col-md-6">
                        <p>Copyright © <a href="">MIST-BlOODDONATE.com</a> | All right reserved.</p>
                    </div>
